  ...
  return {
    ...
    subjects: [
      ...
      emTm(
        `ap-${no}-ps`,
        "Physical Science",
        `General Science (Physical) — Class ${roman}`,
        `సాధారణ శాస్త్రం (భౌతిక) — ${roman} తరగతి`,
        `class ${no} general science physical`,
        ["Science", "Physics", "Chemistry"],
      ),
      emTm(
        `ap-${no}-bio`,
        "Biological Science",
        `General Science (Biology) — Class ${roman}`,
        `సాధారణ శాస్త్రం (జీవ) — ${roman} తరగతి`,
        `class ${no} general science biology`,
        ["Science", "Biology"],
      ),
      emTm(
        `ap-${no}-social`,
